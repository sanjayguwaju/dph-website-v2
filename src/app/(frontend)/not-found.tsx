...
export default function NotFound() {
  ...
  const labels = {
    title: locale === "ne" ? "पृष्ठ फेला परेन" : "Page Not Found",
    desc: locale === "ne" ? "तपाईंले खोजिरहनुभएको पृष्ठ अवस्थित छैन।" : "The page you are looking for does not exist.",
    home: locale === "ne" ? "गृहपृष्ठ" : "Back to Home",
